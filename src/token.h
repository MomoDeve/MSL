		...
		struct Token
		{
			...
			*/
			...
			enum Type : uint32_t
			{
				...
				ASSIGN_OP =            (BINARY_OPERAND + 3)  | 0x00100000,
				SUM_ASSIGN_OP =        (BINARY_OPERAND + 4)  | 0x00100000,
				SUB_ASSIGN_OP =        (BINARY_OPERAND + 5)  | 0x00100000,
				MULT_ASSIGN_OP =       (BINARY_OPERAND + 6)  | 0x00100000,
				DIV_ASSIGN_OP =        (BINARY_OPERAND + 7)  | 0x00100000,
				MOD_ASSIGN_OP =        (BINARY_OPERAND + 8)  | 0x00100000,
				LOGIC_EQUALS =         (BINARY_OPERAND + 9)  | 0x00200000,
				LOGIC_NOT_EQUALS =     (BINARY_OPERAND + 10) | 0x00200000,
				LOGIC_LESS =           (BINARY_OPERAND + 11) | 0x00200000,
				LOGIC_GREATER =        (BINARY_OPERAND + 12) | 0x00200000,
				LOGIC_LESS_EQUALS =    (BINARY_OPERAND + 13) | 0x00200000,
				LOGIC_GREATER_EQUALS = (BINARY_OPERAND + 14) | 0x00200000,
				LOGIC_OR =             (BINARY_OPERAND + 15) | 0x00300000,
				LOGIC_AND =            (BINARY_OPERAND + 16) | 0x00400000,
				SUM_OP =               (BINARY_OPERAND + 17) | 0x00500000,
				SUB_OP =               (BINARY_OPERAND + 18) | 0x00500000,
				MULT_OP =              (BINARY_OPERAND + 19) | 0x00600000,
				DIV_OP =               (BINARY_OPERAND + 20) | 0x00600000,
				MOD_OP =               (BINARY_OPERAND + 21) | 0x00600000,
				POWER_OP =             (BINARY_OPERAND + 22) | 0x00700000,
